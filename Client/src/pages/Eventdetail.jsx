      ...
      {loading ? (
        ...
        <>
          ...
          <div className="relative h-[350px] md:h-[450px] w-full overflow-hidden">
            <img src={event.eventImg} alt={event.title} className="w-full h-full object-cover" />
            ...
            <div className="sticky top-24 h-fit">
              <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col gap-4">
                ...
                <button
                  ...
                  className="mt-4 bg-black text-white py-3 rounded-xl hover:bg-gray-800 transition font-semibold"
                >
                  Book Now
                </button>
